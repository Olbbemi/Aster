...
- 명세서를 기록할 때는 [논의 내용의 배치](references/specification.md#논의-내용의-배치)에 따라 관련 항목을 채우고, 저장 후 [기록 대조](references/specification.md#명세서-작성-시-확인할-사항)를 수행한다. 전체 형식은 같은 문서를 따른다.
